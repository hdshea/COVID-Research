...
owid_full_dataset %>%
  ...
  ggplot(aes(date, new_tests_smoothed_per_thousand, color = location)) +
  geom_line() +
  scale_x_date(limits = c(xlim, NA), date_breaks = "1 month", date_labels = "%b %y") +
  theme(legend.position = "bottom") +
  labs(
    title = "New Tests per 1000 People",
    subtitle = "G7 Countries",
    caption = "Source:  Our World in Data",
    color = "Country",
    x = "Date",
    y = "7-Day Smoothed"
...
owid_full_dataset %>%
  ...
  labs(
    title = "New Tests per 1000 People",
    subtitle = "Americas (Larger Populations)",
    caption = "Source:  Our World in Data",
    color = "Country",
    x = "Date",
    y = "7-Day Smoothed"
...
owid_full_dataset %>%
  ...
  labs(
    title = "New Tests per 1000 People",
    subtitle = "Southeast Asia (Larger Populations)",
    caption = "Source:  Our World in Data",
    color = "Country",
    x = "Date",
    y = "7-Day Smoothed"
...
owid_full_dataset %>%
  ...
  labs(
    title = "New Tests per 1000 People",
    subtitle = "Western Asia (Larger Populations)",
    caption = "Source:  Our World in Data",
    color = "Country",
    x = "Date",
    y = "7-Day Smoothed"
...
owid_full_dataset %>%
  ...
  labs(
    title = "New Tests per 1000 People",
    subtitle = "Mideast (Larger Populations)",
    caption = "Source:  Our World in Data",
    color = "Country",
    x = "Date",
    y = "7-Day Smoothed"
...
owid_full_dataset %>%
  ...
  labs(
    title = "New Tests per 1000 People",
    subtitle = "Africa (Larger Populations)",
    caption = "Source:  Our World in Data",
    color = "Country",
    x = "Date",
    y = "7-Day Smoothed"
...
owid_full_dataset %>%
  ...
  labs(
    title = "New Tests per 1000 People",
    subtitle = "Europe (Larger Populations)",
    caption = "Source:  Our World in Data",
    color = "Country",
    x = "Date",
    y = "7-Day Smoothed"
...
owid_full_dataset %>%
  ...
  ggplot(aes(date, positive_rate, color = location)) +
  geom_line() +
  scale_x_date(limits = c(xlim, NA), date_breaks = "1 month", date_labels = "%b %y") +
  theme(legend.position = "bottom") +
  labs(
